<form 
    action="{{ isset($produkEdit) ? route('admin.produks.update', $produkEdit->id) : route('admin.produks.store') }}" 
    method="POST" 
        ...
        <div>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="harga_produk" name="harga_produk"
                    value="{{ old('harga_produk', $produkEdit->harga_produk ?? '') }}"
            ...
            <div class="mb-4">
                ...
                <textarea id="deskripsi_produk" name="deskripsi_produk" rows="4"
                    ...
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-400 resize-none">{{ old('deskripsi_produk', $produkEdit->deskripsi_produk ?? '') }}</textarea>
            </div>
        </div>
        ...
        <div>
                ...
                <select id="id_kategori" name="id_kategori"
                    ...
                    @foreach($kategoris as $kategori)
                        <option value="{{ $kategori->id }}"
                            {{ old('id_kategori', $produkEdit->id_kategori ?? '') == $kategori->id ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="stok_produk" name="stok_produk"
                    value="{{ old('stok_produk', $produkEdit->stok_produk ?? '') }}"
            ...
            <div class="mb-4">
                ...
                @if(isset($produkEdit) && $produkEdit->gambar_produk)
                    <img src="{{ asset('storage/' . $produkEdit->gambar_produk) }}" class="h-16 w-auto rounded border border-gray-300" />
                @endif
            </div>
        </div>
    </div>
